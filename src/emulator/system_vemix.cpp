...
system_vemix::system_vemix(const options &init_options, const elf::binary & __restrict binary) : system(init_options, binary)
{
}
...
uint32 system_vemix::handle_exception(const CPU_Exception &ex)
{
   if (ex.m_ExceptionType == CPU_Exception::Type::Sys)
   {
      ...
      switch (code)
      {
         ...
         case __NR_mmap2:
         {
            static constexpr uint32 MAP_SHARED     = 0x01;
            static constexpr uint32 MAP_PRIVATE    = 0x02;
            static constexpr uint32 MAP_TYPE       = 0x0f;
            static constexpr uint32 MAP_FIXED      = 0x10;
            static constexpr uint32 MAP_ANON       = 0x20;
            static constexpr uint32 MAP_ANONYMOUS  = MAP_ANON;
            static constexpr uint32 MAP_NORESERVE  = 0x4000;
            static constexpr uint32 MAP_GROWSDOWN  = 0x0100;
            static constexpr uint32 MAP_DENYWRITE  = 0x0800;
            static constexpr uint32 MAP_EXECUTABLE = 0x1000;
            static constexpr uint32 MAP_LOCKED     = 0x2000;
            static constexpr uint32 MAP_POPULATE   = 0x8000;
            static constexpr uint32 MAP_NONBLOCK   = 0x10000;
            static constexpr uint32 MAP_STACK      = 0x20000;
            static constexpr uint32 MAP_HUGETLB    = 0x40000;
            static constexpr uint32 MAP_FILE       = 0;

            static constexpr uint32 PROT_NONE      = 0;
            static constexpr uint32 PROT_READ      = 1;
            static constexpr uint32 PROT_WRITE     = 2;
            static constexpr uint32 PROT_EXEC      = 4;
            static constexpr uint32 PROT_GROWSDOWN = 0x01000000;
            static constexpr uint32 PROT_GROWSUP   = 0x02000000;
