...
//#define get_register_op8(reg) byte[rbp + sbyte_assert(gp_offset + (4 * reg ## .get_register()))]
//#define get_register_op16(reg) word[rbp + sbyte_assert(gp_offset + (4 * reg ## .get_register()))]
//#define get_register_op32(reg) dword[rbp + sbyte_assert(gp_offset + (4 * reg ## .get_register()))]
//#define get_register_op64(reg) qword[rbp + sbyte_assert(gp_offset + (4 * reg ## .get_register()))]
      ...
      const Xbyak::Operand & get_register_op8(const GPR &reg)
      {
         ...
         const int8 reg_offset = sbyte_assert(gp_offset + (4 * reg.get_register()));
      ...
      void write_PROC_RDHWR(jit1::ChunkOffset & __restrict chunk_offset, uint32 address, instruction_t instruction, const mips::instructions::InstructionInfo & __restrict instruction_info) __restrict;
