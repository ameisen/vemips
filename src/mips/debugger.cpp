...
namespace
{
   ...
   static std::vector<char> assemble_packet(const std::vector<char> &payload)
   {
...
static bool begins(const std::string &str, const std::string &ref)
{
...
static bool test_checksum(const std::vector<char> &packet)
{
...
bool debugger::handle_packet(const std::vector<char> &packet, std::vector<char> &response)
{
