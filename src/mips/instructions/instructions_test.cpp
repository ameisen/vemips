...
static const mips::instructions::InstructionInfo StaticProc_PROC_EHB ( "PROC_EHB", false, 1, &mips::instructions::PROC_EHB_NS::Execute, 0x0, 'n' );
static const mips::instructions::InstructionInfo StaticProc_PROC_NOP ( "PROC_NOP", false, 1, &mips::instructions::PROC_NOP_NS::Execute, 0x0, 'n' );
static const mips::instructions::InstructionInfo StaticProc_PROC_PAUSE ( "PROC_PAUSE", true, 1, &mips::instructions::PROC_PAUSE_NS::Execute, 0x20000, 'n' );
static const mips::instructions::InstructionInfo StaticProc_PROC_SSNOP ( "PROC_SSNOP", false, 1, &mips::instructions::PROC_SSNOP_NS::Execute, 0x0, 'n' );
static const mips::instructions::InstructionInfo StaticProc_COP1_SWC1_v ( "COP1_SWC1", false, 1, &mips::instructions::COP1_SWC1_NS::Execute<void>, 0x12000, 'v' );
static const mips::instructions::InstructionInfo StaticProc_PROC_AUI ( "PROC_AUI", false, 1, &mips::instructions::PROC_AUI_NS::Execute, 0x0, 'n' );
static const mips::instructions::InstructionInfo StaticProc_PROC_BC ( "PROC_BC", true, 1, &mips::instructions::PROC_BC_NS::Execute, 0xa0000, 'n' );
static const mips::instructions::InstructionInfo StaticProc_PROC_POP30 ( "PROC_POP30", true, 1, &mips::instructions::PROC_POP30_NS::Execute, 0x1a0000, 'n' );
static const mips::instructions::InstructionInfo StaticProc_PROC_XORI ( "PROC_XORI", false, 1, &mips::instructions::PROC_XORI_NS::Execute, 0x0, 'n' );
static const mips::instructions::InstructionInfo StaticProc_COP1_CLASS_d ( "COP1_CLASS", false, 1, &mips::instructions::COP1_CLASS_NS::Execute<double>, 0x12000, 'd' );
static const mips::instructions::InstructionInfo StaticProc_COP1_CVT_W_d ( "COP1_CVT_W", false, 1, &mips::instructions::COP1_CVT_W_NS::Execute<double>, 0xc7, 'd' );
static const mips::instructions::InstructionInfo StaticProc_COP1_TRUNC_W_d ( "COP1_TRUNC_W", false, 1, &mips::instructions::COP1_TRUNC_W_NS::Execute<double>, 0xc7, 'd' );
static const mips::instructions::InstructionInfo StaticProc_COP1_RSQRT_d ( "COP1_RSQRT", false, 1, &mips::instructions::COP1_RSQRT_NS::Execute<double>, 0x7f, 'd' );
static const mips::instructions::InstructionInfo StaticProc_COP1_ROUND_L_d ( "COP1_ROUND_L", false, 1, &mips::instructions::COP1_ROUND_L_NS::Execute<double>, 0xc7, 'd' );
static const mips::instructions::InstructionInfo StaticProc_COP1_FLOOR_L_d ( "COP1_FLOOR_L", false, 1, &mips::instructions::COP1_FLOOR_L_NS::Execute<double>, 0xc7, 'd' );
static const mips::instructions::InstructionInfo StaticProc_COP1_MOV_d ( "COP1_MOV", false, 1, &mips::instructions::COP1_MOV_NS::Execute<double>, 0x12000, 'd' );
static const mips::instructions::InstructionInfo StaticProc_COP1_CVT_L_d ( "COP1_CVT_L", false, 1, &mips::instructions::COP1_CVT_L_NS::Execute<double>, 0xc7, 'd' );
static const mips::instructions::InstructionInfo StaticProc_COP1_CEIL_W_d ( "COP1_CEIL_W", false, 1, &mips::instructions::COP1_CEIL_W_NS::Execute<double>, 0xc7, 'd' );
static const mips::instructions::InstructionInfo StaticProc_COP1_CVT_S_d ( "COP1_CVT_S", false, 1, &mips::instructions::COP1_CVT_S_NS::Execute<double>, 0x47, 'd' );
static const mips::instructions::InstructionInfo StaticProc_COP1_TRUNC_L_d ( "COP1_TRUNC_L", false, 1, &mips::instructions::COP1_TRUNC_L_NS::Execute<double>, 0xc7, 'd' );
static const mips::instructions::InstructionInfo StaticProc_COP1_SQRT_d ( "COP1_SQRT", false, 1, &mips::instructions::COP1_SQRT_NS::Execute<double>, 0x47, 'd' );
static const mips::instructions::InstructionInfo StaticProc_COP1_RINT_d ( "COP1_RINT", false, 1, &mips::instructions::COP1_RINT_NS::Execute<double>, 0x77, 'd' );
static const mips::instructions::InstructionInfo StaticProc_COP1_ROUND_W_d ( "COP1_ROUND_W", false, 1, &mips::instructions::COP1_ROUND_W_NS::Execute<double>, 0xc7, 'd' );
static const mips::instructions::InstructionInfo StaticProc_COP1_RECIP_d ( "COP1_RECIP", false, 1, &mips::instructions::COP1_RECIP_NS::Execute<double>, 0x7f, 'd' );
static const mips::instructions::InstructionInfo StaticProc_COP1_NEG_d ( "COP1_NEG", false, 1, &mips::instructions::COP1_NEG_NS::Execute<double>, 0x12000, 'd' );
static const mips::instructions::InstructionInfo StaticProc_COP1_FLOOR_W_d ( "COP1_FLOOR_W", false, 1, &mips::instructions::COP1_FLOOR_W_NS::Execute<double>, 0xc7, 'd' );
static const mips::instructions::InstructionInfo StaticProc_COP1_CVT_D_d ( "COP1_CVT_D", false, 1, &mips::instructions::COP1_CVT_D_NS::Execute<double>, 0x47, 'd' );
static const mips::instructions::InstructionInfo StaticProc_COP1_CEIL_L_d ( "COP1_CEIL_L", false, 1, &mips::instructions::COP1_CEIL_L_NS::Execute<double>, 0xc7, 'd' );
static const mips::instructions::InstructionInfo StaticProc_COP1_ABS_d ( "COP1_ABS", false, 1, &mips::instructions::COP1_ABS_NS::Execute<double>, 0x12000, 'd' );
static const mips::instructions::InstructionInfo StaticProc_COP1_SELNEZ_d ( "COP1_SELNEZ", false, 1, &mips::instructions::COP1_SELNEZ_NS::Execute<double>, 0x12000, 'd' );
static const mips::instructions::InstructionInfo StaticProc_COP1_ADD_d ( "COP1_ADD", false, 1, &mips::instructions::COP1_ADD_NS::Execute<double>, 0x77, 'd' );
static const mips::instructions::InstructionInfo StaticProc_COP1_MAXA_d ( "COP1_MAXA", false, 1, &mips::instructions::COP1_MAXA_NS::Execute<double>, 0x12007, 'd' );
static const mips::instructions::InstructionInfo StaticProc_COP1_DIV_d ( "COP1_DIV", false, 1, &mips::instructions::COP1_DIV_NS::Execute<double>, 0x7f, 'd' );
static const mips::instructions::InstructionInfo StaticProc_COP1_MAX_d ( "COP1_MAX", false, 1, &mips::instructions::COP1_MAX_NS::Execute<double>, 0x12007, 'd' );
static const mips::instructions::InstructionInfo StaticProc_COP1_SEL_d ( "COP1_SEL", false, 1, &mips::instructions::COP1_SEL_NS::Execute<double>, 0x12000, 'd' );
static const mips::instructions::InstructionInfo StaticProc_COP1_MSUBF_d ( "COP1_MSUBF", false, 1, &mips::instructions::COP1_MSUBF_NS::Execute<double>, 0x77, 'd' );
static const mips::instructions::InstructionInfo StaticProc_COP1_MUL_d ( "COP1_MUL", false, 1, &mips::instructions::COP1_MUL_NS::Execute<double>, 0x77, 'd' );
static const mips::instructions::InstructionInfo StaticProc_COP1_SELEQZ_d ( "COP1_SELEQZ", false, 1, &mips::instructions::COP1_SELEQZ_NS::Execute<double>, 0x12000, 'd' );
static const mips::instructions::InstructionInfo StaticProc_COP1_MINA_d ( "COP1_MINA", false, 1, &mips::instructions::COP1_MINA_NS::Execute<double>, 0x12007, 'd' );
static const mips::instructions::InstructionInfo StaticProc_COP1_MADDF_d ( "COP1_MADDF", false, 1, &mips::instructions::COP1_MADDF_NS::Execute<double>, 0x77, 'd' );
static const mips::instructions::InstructionInfo StaticProc_COP1_SUB_d ( "COP1_SUB", false, 1, &mips::instructions::COP1_SUB_NS::Execute<double>, 0x77, 'd' );
static const mips::instructions::InstructionInfo StaticProc_COP1_MIN_d ( "COP1_MIN", false, 1, &mips::instructions::COP1_MIN_NS::Execute<double>, 0x12007, 'd' );
static const mips::instructions::InstructionInfo StaticProc_COP1_MTHC1_v ( "COP1_MTHC1", false, 1, &mips::instructions::COP1_MTHC1_NS::Execute<void>, 0x12000, 'v' );
static const mips::instructions::InstructionInfo StaticProc_COP1_MFHC1_v ( "COP1_MFHC1", false, 1, &mips::instructions::COP1_MFHC1_NS::Execute<void>, 0x12000, 'v' );
static const mips::instructions::InstructionInfo StaticProc_COP1_BC1NEZ_v ( "COP1_BC1NEZ", true, 1, &mips::instructions::COP1_BC1NEZ_NS::Execute<void>, 0x172000, 'v' );
static const mips::instructions::InstructionInfo StaticProc_COP1_BC1EQZ_v ( "COP1_BC1EQZ", true, 1, &mips::instructions::COP1_BC1EQZ_NS::Execute<void>, 0x172000, 'v' );
static const mips::instructions::InstructionInfo StaticProc_COP1_CVT_D_w ( "COP1_CVT_D", false, 1, &mips::instructions::COP1_CVT_D_NS::Execute<int32>, 0x47, 'w' );
static const mips::instructions::InstructionInfo StaticProc_COP1_CVT_S_w ( "COP1_CVT_S", false, 1, &mips::instructions::COP1_CVT_S_NS::Execute<int32>, 0x47, 'w' );
static const mips::instructions::InstructionInfo StaticProc_COP1_CMP_condn_s_v ( "COP1_CMP_condn_s", false, 1, &mips::instructions::COP1_CMP_condn_s_NS::Execute<void>, 0x12000, 'v' );
static const mips::instructions::InstructionInfo StaticProc_COP1_NEG_f ( "COP1_NEG", false, 1, &mips::instructions::COP1_NEG_NS::Execute<float>, 0x12000, 'f' );
static const mips::instructions::InstructionInfo StaticProc_COP1_FLOOR_W_f ( "COP1_FLOOR_W", false, 1, &mips::instructions::COP1_FLOOR_W_NS::Execute<float>, 0xc7, 'f' );
static const mips::instructions::InstructionInfo StaticProc_COP1_CVT_D_f ( "COP1_CVT_D", false, 1, &mips::instructions::COP1_CVT_D_NS::Execute<float>, 0x47, 'f' );
static const mips::instructions::InstructionInfo StaticProc_COP1_CEIL_L_f ( "COP1_CEIL_L", false, 1, &mips::instructions::COP1_CEIL_L_NS::Execute<float>, 0xc7, 'f' );
static const mips::instructions::InstructionInfo StaticProc_COP1_ABS_f ( "COP1_ABS", false, 1, &mips::instructions::COP1_ABS_NS::Execute<float>, 0x12000, 'f' );
static const mips::instructions::InstructionInfo StaticProc_COP1_CLASS_f ( "COP1_CLASS", false, 1, &mips::instructions::COP1_CLASS_NS::Execute<float>, 0x12000, 'f' );
static const mips::instructions::InstructionInfo StaticProc_COP1_CVT_W_f ( "COP1_CVT_W", false, 1, &mips::instructions::COP1_CVT_W_NS::Execute<float>, 0xc7, 'f' );
static const mips::instructions::InstructionInfo StaticProc_COP1_TRUNC_W_f ( "COP1_TRUNC_W", false, 1, &mips::instructions::COP1_TRUNC_W_NS::Execute<float>, 0xc7, 'f' );
static const mips::instructions::InstructionInfo StaticProc_COP1_RSQRT_f ( "COP1_RSQRT", false, 1, &mips::instructions::COP1_RSQRT_NS::Execute<float>, 0x7f, 'f' );
static const mips::instructions::InstructionInfo StaticProc_COP1_ROUND_L_f ( "COP1_ROUND_L", false, 1, &mips::instructions::COP1_ROUND_L_NS::Execute<float>, 0xc7, 'f' );
static const mips::instructions::InstructionInfo StaticProc_COP1_FLOOR_L_f ( "COP1_FLOOR_L", false, 1, &mips::instructions::COP1_FLOOR_L_NS::Execute<float>, 0xc7, 'f' );
static const mips::instructions::InstructionInfo StaticProc_COP1_MOV_f ( "COP1_MOV", false, 1, &mips::instructions::COP1_MOV_NS::Execute<float>, 0x12000, 'f' );
static const mips::instructions::InstructionInfo StaticProc_COP1_CVT_L_f ( "COP1_CVT_L", false, 1, &mips::instructions::COP1_CVT_L_NS::Execute<float>, 0xc7, 'f' );
static const mips::instructions::InstructionInfo StaticProc_COP1_CEIL_W_f ( "COP1_CEIL_W", false, 1, &mips::instructions::COP1_CEIL_W_NS::Execute<float>, 0xc7, 'f' );
static const mips::instructions::InstructionInfo StaticProc_COP1_CVT_S_f ( "COP1_CVT_S", false, 1, &mips::instructions::COP1_CVT_S_NS::Execute<float>, 0x47, 'f' );
static const mips::instructions::InstructionInfo StaticProc_COP1_TRUNC_L_f ( "COP1_TRUNC_L", false, 1, &mips::instructions::COP1_TRUNC_L_NS::Execute<float>, 0xc7, 'f' );
static const mips::instructions::InstructionInfo StaticProc_COP1_SQRT_f ( "COP1_SQRT", false, 1, &mips::instructions::COP1_SQRT_NS::Execute<float>, 0x47, 'f' );
static const mips::instructions::InstructionInfo StaticProc_COP1_RINT_f ( "COP1_RINT", false, 1, &mips::instructions::COP1_RINT_NS::Execute<float>, 0x77, 'f' );
static const mips::instructions::InstructionInfo StaticProc_COP1_ROUND_W_f ( "COP1_ROUND_W", false, 1, &mips::instructions::COP1_ROUND_W_NS::Execute<float>, 0xc7, 'f' );
static const mips::instructions::InstructionInfo StaticProc_COP1_RECIP_f ( "COP1_RECIP", false, 1, &mips::instructions::COP1_RECIP_NS::Execute<float>, 0x7f, 'f' );
static const mips::instructions::InstructionInfo StaticProc_COP1_SEL_f ( "COP1_SEL", false, 1, &mips::instructions::COP1_SEL_NS::Execute<float>, 0x12000, 'f' );
static const mips::instructions::InstructionInfo StaticProc_COP1_MSUBF_f ( "COP1_MSUBF", false, 1, &mips::instructions::COP1_MSUBF_NS::Execute<float>, 0x77, 'f' );
static const mips::instructions::InstructionInfo StaticProc_COP1_MUL_f ( "COP1_MUL", false, 1, &mips::instructions::COP1_MUL_NS::Execute<float>, 0x77, 'f' );
static const mips::instructions::InstructionInfo StaticProc_COP1_SELEQZ_f ( "COP1_SELEQZ", false, 1, &mips::instructions::COP1_SELEQZ_NS::Execute<float>, 0x12000, 'f' );
static const mips::instructions::InstructionInfo StaticProc_COP1_MINA_f ( "COP1_MINA", false, 1, &mips::instructions::COP1_MINA_NS::Execute<float>, 0x12007, 'f' );
static const mips::instructions::InstructionInfo StaticProc_COP1_MADDF_f ( "COP1_MADDF", false, 1, &mips::instructions::COP1_MADDF_NS::Execute<float>, 0x77, 'f' );
static const mips::instructions::InstructionInfo StaticProc_COP1_SUB_f ( "COP1_SUB", false, 1, &mips::instructions::COP1_SUB_NS::Execute<float>, 0x77, 'f' );
static const mips::instructions::InstructionInfo StaticProc_COP1_MIN_f ( "COP1_MIN", false, 1, &mips::instructions::COP1_MIN_NS::Execute<float>, 0x12007, 'f' );
static const mips::instructions::InstructionInfo StaticProc_COP1_SELNEZ_f ( "COP1_SELNEZ", false, 1, &mips::instructions::COP1_SELNEZ_NS::Execute<float>, 0x12000, 'f' );
static const mips::instructions::InstructionInfo StaticProc_COP1_ADD_f ( "COP1_ADD", false, 1, &mips::instructions::COP1_ADD_NS::Execute<float>, 0x77, 'f' );
static const mips::instructions::InstructionInfo StaticProc_COP1_MAXA_f ( "COP1_MAXA", false, 1, &mips::instructions::COP1_MAXA_NS::Execute<float>, 0x12007, 'f' );
static const mips::instructions::InstructionInfo StaticProc_COP1_DIV_f ( "COP1_DIV", false, 1, &mips::instructions::COP1_DIV_NS::Execute<float>, 0x7f, 'f' );
static const mips::instructions::InstructionInfo StaticProc_COP1_MAX_f ( "COP1_MAX", false, 1, &mips::instructions::COP1_MAX_NS::Execute<float>, 0x12007, 'f' );
static const mips::instructions::InstructionInfo StaticProc_COP1_MTC1_v ( "COP1_MTC1", false, 1, &mips::instructions::COP1_MTC1_NS::Execute<void>, 0x12000, 'v' );
static const mips::instructions::InstructionInfo StaticProc_COP1_CTC1_v ( "COP1_CTC1", false, 1, &mips::instructions::COP1_CTC1_NS::Execute<void>, 0x12000, 'v' );
static const mips::instructions::InstructionInfo StaticProc_COP1_CFC1_v ( "COP1_CFC1", false, 1, &mips::instructions::COP1_CFC1_NS::Execute<void>, 0x1207f, 'v' );
static const mips::instructions::InstructionInfo StaticProc_COP1_MFC1_v ( "COP1_MFC1", false, 1, &mips::instructions::COP1_MFC1_NS::Execute<void>, 0x12000, 'v' );
static const mips::instructions::InstructionInfo StaticProc_COP1_CVT_D_l ( "COP1_CVT_D", false, 1, &mips::instructions::COP1_CVT_D_NS::Execute<int64>, 0x47, 'l' );
static const mips::instructions::InstructionInfo StaticProc_COP1_CVT_S_l ( "COP1_CVT_S", false, 1, &mips::instructions::COP1_CVT_S_NS::Execute<int64>, 0x47, 'l' );
static const mips::instructions::InstructionInfo StaticProc_COP1_CMP_condn_d_v ( "COP1_CMP_condn_d", false, 1, &mips::instructions::COP1_CMP_condn_d_NS::Execute<void>, 0x12000, 'v' );
static const mips::instructions::InstructionInfo StaticProc_COP1_LWC1_v ( "COP1_LWC1", false, 1, &mips::instructions::COP1_LWC1_NS::Execute<void>, 0x12000, 'v' );
static const mips::instructions::InstructionInfo StaticProc_PROC_BGTZALC ( "PROC_BGTZALC", true, 1, &mips::instructions::PROC_BGTZALC_NS::Execute, 0x1a0000, 'n' );
static const mips::instructions::InstructionInfo StaticProc_PROC_BGTZ ( "PROC_BGTZ", true, 1, &mips::instructions::PROC_BGTZ_NS::Execute, 0x160000, 'n' );
static const mips::instructions::InstructionInfo StaticProc_PROC_POP07 ( "PROC_POP07", true, 1, &mips::instructions::PROC_POP07_NS::Execute, 0x1a0000, 'n' );
static const mips::instructions::InstructionInfo StaticProc_PROC_ORI ( "PROC_ORI", false, 1, &mips::instructions::PROC_ORI_NS::Execute, 0x0, 'n' );
static const mips::instructions::InstructionInfo StaticProc_PROC_BLEZALC ( "PROC_BLEZALC", true, 1, &mips::instructions::PROC_BLEZALC_NS::Execute, 0x1a0000, 'n' );
static const mips::instructions::InstructionInfo StaticProc_PROC_BLEZ ( "PROC_BLEZ", true, 1, &mips::instructions::PROC_BLEZ_NS::Execute, 0x160000, 'n' );
static const mips::instructions::InstructionInfo StaticProc_PROC_POP06 ( "PROC_POP06", true, 1, &mips::instructions::PROC_POP06_NS::Execute, 0x1a0000, 'n' );
static const mips::instructions::InstructionInfo StaticProc_PROC_ANDI ( "PROC_ANDI", false, 1, &mips::instructions::PROC_ANDI_NS::Execute, 0x0, 'n' );
static const mips::instructions::InstructionInfo StaticProc_PROC_BITSWAP ( "PROC_BITSWAP", false, 1, &mips::instructions::PROC_BITSWAP_NS::Execute, 0x0, 'n' );
static const mips::instructions::InstructionInfo StaticProc_PROC_SEB ( "PROC_SEB", false, 1, &mips::instructions::PROC_SEB_NS::Execute, 0x0, 'n' );
static const mips::instructions::InstructionInfo StaticProc_PROC_SEH ( "PROC_SEH", false, 1, &mips::instructions::PROC_SEH_NS::Execute, 0x0, 'n' );
static const mips::instructions::InstructionInfo StaticProc_PROC_WSBH ( "PROC_WSBH", false, 1, &mips::instructions::PROC_WSBH_NS::Execute, 0x0, 'n' );
static const mips::instructions::InstructionInfo StaticProc_PROC_SCWPE ( "PROC_SCWPE", false, 1, &mips::instructions::PROC_SCWPE_NS::Execute, 0x0, 'n' );
static const mips::instructions::InstructionInfo StaticProc_PROC_SCE ( "PROC_SCE", false, 1, &mips::instructions::PROC_SCE_NS::Execute, 0x0, 'n' );
static const mips::instructions::InstructionInfo StaticProc_PROC_LWE ( "PROC_LWE", false, 1, &mips::instructions::PROC_LWE_NS::Execute, 0x0, 'n' );
static const mips::instructions::InstructionInfo StaticProc_PROC_SBE ( "PROC_SBE", false, 1, &mips::instructions::PROC_SBE_NS::Execute, 0x0, 'n' );
static const mips::instructions::InstructionInfo StaticProc_PROC_CACHE ( "PROC_CACHE", false, 1, &mips::instructions::PROC_CACHE_NS::Execute, 0x0, 'n' );
static const mips::instructions::InstructionInfo StaticProc_PROC_ALIGN ( "PROC_ALIGN", false, 1, &mips::instructions::PROC_ALIGN_NS::Execute, 0x0, 'n' );
static const mips::instructions::InstructionInfo StaticProc_PROC_RDHWR ( "PROC_RDHWR", false, 1, &mips::instructions::PROC_RDHWR_NS::Execute, 0x0, 'n' );
static const mips::instructions::InstructionInfo StaticProc_PROC_INS ( "PROC_INS", false, 1, &mips::instructions::PROC_INS_NS::Execute, 0x0, 'n' );
static const mips::instructions::InstructionInfo StaticProc_PROC_LHE ( "PROC_LHE", false, 1, &mips::instructions::PROC_LHE_NS::Execute, 0x0, 'n' );
static const mips::instructions::InstructionInfo StaticProc_PROC_LLWP ( "PROC_LLWP", false, 1, &mips::instructions::PROC_LLWP_NS::Execute, 0x0, 'n' );
static const mips::instructions::InstructionInfo StaticProc_PROC_LL ( "PROC_LL", false, 1, &mips::instructions::PROC_LL_NS::Execute, 0x0, 'n' );
static const mips::instructions::InstructionInfo StaticProc_PROC_SWE ( "PROC_SWE", false, 1, &mips::instructions::PROC_SWE_NS::Execute, 0x0, 'n' );
static const mips::instructions::InstructionInfo StaticProc_PROC_LBUE ( "PROC_LBUE", false, 1, &mips::instructions::PROC_LBUE_NS::Execute, 0x0, 'n' );
static const mips::instructions::InstructionInfo StaticProc_PROC_PREFE ( "PROC_PREFE", false, 1, &mips::instructions::PROC_PREFE_NS::Execute, 0x0, 'n' );
static const mips::instructions::InstructionInfo StaticProc_PROC_SHE ( "PROC_SHE", false, 1, &mips::instructions::PROC_SHE_NS::Execute, 0x0, 'n' );
static const mips::instructions::InstructionInfo StaticProc_PROC_SCWP ( "PROC_SCWP", false, 1, &mips::instructions::PROC_SCWP_NS::Execute, 0x0, 'n' );
static const mips::instructions::InstructionInfo StaticProc_PROC_SC ( "PROC_SC", false, 1, &mips::instructions::PROC_SC_NS::Execute, 0x0, 'n' );
static const mips::instructions::InstructionInfo StaticProc_PROC_LLWPE ( "PROC_LLWPE", false, 1, &mips::instructions::PROC_LLWPE_NS::Execute, 0x0, 'n' );
static const mips::instructions::InstructionInfo StaticProc_PROC_LLE ( "PROC_LLE", false, 1, &mips::instructions::PROC_LLE_NS::Execute, 0x0, 'n' );
static const mips::instructions::InstructionInfo StaticProc_PROC_EXT ( "PROC_EXT", false, 1, &mips::instructions::PROC_EXT_NS::Execute, 0x0, 'n' );
static const mips::instructions::InstructionInfo StaticProc_PROC_LHUE ( "PROC_LHUE", false, 1, &mips::instructions::PROC_LHUE_NS::Execute, 0x0, 'n' );
static const mips::instructions::InstructionInfo StaticProc_PROC_LBE ( "PROC_LBE", false, 1, &mips::instructions::PROC_LBE_NS::Execute, 0x0, 'n' );
static const mips::instructions::InstructionInfo StaticProc_PROC_PREF ( "PROC_PREF", false, 1, &mips::instructions::PROC_PREF_NS::Execute, 0x0, 'n' );
static const mips::instructions::InstructionInfo StaticProc_PROC_BNE ( "PROC_BNE", true, 1, &mips::instructions::PROC_BNE_NS::Execute, 0x160000, 'n' );
static const mips::instructions::InstructionInfo StaticProc_PROC_LHU ( "PROC_LHU", false, 1, &mips::instructions::PROC_LHU_NS::Execute, 0x0, 'n' );
static const mips::instructions::InstructionInfo StaticProc_PROC_SLTIU ( "PROC_SLTIU", false, 1, &mips::instructions::PROC_SLTIU_NS::Execute, 0x0, 'n' );
static const mips::instructions::InstructionInfo StaticProc_PROC_SW ( "PROC_SW", false, 1, &mips::instructions::PROC_SW_NS::Execute, 0x0, 'n' );
static const mips::instructions::InstructionInfo StaticProc_PROC_JIALC ( "PROC_JIALC", true, 1, &mips::instructions::PROC_JIALC_NS::Execute, 0xa0000, 'n' );
static const mips::instructions::InstructionInfo StaticProc_PROC_BNEZC ( "PROC_BNEZC", true, 1, &mips::instructions::PROC_BNEZC_NS::Execute, 0x1a0000, 'n' );
static const mips::instructions::InstructionInfo StaticProc_PROC_BEQ ( "PROC_BEQ", true, 1, &mips::instructions::PROC_BEQ_NS::Execute, 0x160000, 'n' );
static const mips::instructions::InstructionInfo StaticProc_PROC_LBU ( "PROC_LBU", false, 1, &mips::instructions::PROC_LBU_NS::Execute, 0x0, 'n' );
static const mips::instructions::InstructionInfo StaticProc_PROC_BGTZC ( "PROC_BGTZC", true, 1, &mips::instructions::PROC_BGTZC_NS::Execute, 0x1a0000, 'n' );
static const mips::instructions::InstructionInfo StaticProc_PROC_POP27 ( "PROC_POP27", true, 1, &mips::instructions::PROC_POP27_NS::Execute, 0x1a0000, 'n' );
static const mips::instructions::InstructionInfo StaticProc_PROC_SLTI ( "PROC_SLTI", false, 1, &mips::instructions::PROC_SLTI_NS::Execute, 0x0, 'n' );
static const mips::instructions::InstructionInfo StaticProc_COP1_SDC1_v ( "COP1_SDC1", false, 1, &mips::instructions::COP1_SDC1_NS::Execute<void>, 0x12000, 'v' );
static const mips::instructions::InstructionInfo StaticProc_PROC_JAL ( "PROC_JAL", true, 1, &mips::instructions::PROC_JAL_NS::Execute, 0x160000, 'n' );
static const mips::instructions::InstructionInfo StaticProc_PROC_LW ( "PROC_LW", false, 1, &mips::instructions::PROC_LW_NS::Execute, 0x0, 'n' );
static const mips::instructions::InstructionInfo StaticProc_PROC_MOVE ( "PROC_MOVE", false, 1, &mips::instructions::PROC_MOVE_NS::Execute, 0x0, 'n' );
static const mips::instructions::InstructionInfo StaticProc_PROC_ADDIU ( "PROC_ADDIU", false, 1, &mips::instructions::PROC_ADDIU_NS::Execute, 0x0, 'n' );
static const mips::instructions::InstructionInfo StaticProc_PROC_BLEZC ( "PROC_BLEZC", true, 1, &mips::instructions::PROC_BLEZC_NS::Execute, 0x1a0000, 'n' );
static const mips::instructions::InstructionInfo StaticProc_PROC_POP26 ( "PROC_POP26", true, 1, &mips::instructions::PROC_POP26_NS::Execute, 0x1a0000, 'n' );
static const mips::instructions::InstructionInfo StaticProc_PROC_JIC ( "PROC_JIC", true, 1, &mips::instructions::PROC_JIC_NS::Execute, 0xa0000, 'n' );
static const mips::instructions::InstructionInfo StaticProc_PROC_BEQZC ( "PROC_BEQZC", true, 1, &mips::instructions::PROC_BEQZC_NS::Execute, 0x1a0000, 'n' );
static const mips::instructions::InstructionInfo StaticProc_PROC_SH ( "PROC_SH", false, 1, &mips::instructions::PROC_SH_NS::Execute, 0x0, 'n' );
static const mips::instructions::InstructionInfo StaticProc_PROC_J ( "PROC_J", true, 1, &mips::instructions::PROC_J_NS::Execute, 0x160000, 'n' );
static const mips::instructions::InstructionInfo StaticProc_PROC_POP10 ( "PROC_POP10", true, 1, &mips::instructions::PROC_POP10_NS::Execute, 0x1a0000, 'n' );
static const mips::instructions::InstructionInfo StaticProc_COP1_LDC1_v ( "COP1_LDC1", false, 1, &mips::instructions::COP1_LDC1_NS::Execute<void>, 0x12000, 'v' );
static const mips::instructions::InstructionInfo StaticProc_PROC_SB ( "PROC_SB", false, 1, &mips::instructions::PROC_SB_NS::Execute, 0x0, 'n' );
static const mips::instructions::InstructionInfo StaticProc_PROC_ALUIPC ( "PROC_ALUIPC", false, 1, &mips::instructions::PROC_ALUIPC_NS::Execute, 0x0, 'n' );
static const mips::instructions::InstructionInfo StaticProc_PROC_AUIPC ( "PROC_AUIPC", false, 1, &mips::instructions::PROC_AUIPC_NS::Execute, 0x0, 'n' );
static const mips::instructions::InstructionInfo StaticProc_PROC_LWPC ( "PROC_LWPC", false, 1, &mips::instructions::PROC_LWPC_NS::Execute, 0x0, 'n' );
static const mips::instructions::InstructionInfo StaticProc_PROC_ADDIUPC ( "PROC_ADDIUPC", false, 1, &mips::instructions::PROC_ADDIUPC_NS::Execute, 0x0, 'n' );
static const mips::instructions::InstructionInfo StaticProc_PROC_SIGRIE ( "PROC_SIGRIE", false, 1, &mips::instructions::PROC_SIGRIE_NS::Execute, 0x0, 'n' );
static const mips::instructions::InstructionInfo StaticProc_PROC_BAL ( "PROC_BAL", true, 1, &mips::instructions::PROC_BAL_NS::Execute, 0x160000, 'n' );
static const mips::instructions::InstructionInfo StaticProc_PROC_NAL ( "PROC_NAL", true, 1, &mips::instructions::PROC_NAL_NS::Execute, 0x120000, 'n' );
static const mips::instructions::InstructionInfo StaticProc_PROC_BGEZ ( "PROC_BGEZ", true, 1, &mips::instructions::PROC_BGEZ_NS::Execute, 0x160000, 'n' );
static const mips::instructions::InstructionInfo StaticProc_PROC_BLTZ ( "PROC_BLTZ", true, 1, &mips::instructions::PROC_BLTZ_NS::Execute, 0x160000, 'n' );
static const mips::instructions::InstructionInfo StaticProc_PROC_SYNCI ( "PROC_SYNCI", false, 1, &mips::instructions::PROC_SYNCI_NS::Execute, 0x0, 'n' );
static const mips::instructions::InstructionInfo StaticProc_PROC_LH ( "PROC_LH", false, 1, &mips::instructions::PROC_LH_NS::Execute, 0x0, 'n' );
static const mips::instructions::InstructionInfo StaticProc_PROC_BALC ( "PROC_BALC", true, 1, &mips::instructions::PROC_BALC_NS::Execute, 0xa0000, 'n' );
static const mips::instructions::InstructionInfo StaticProc_PROC_SRA ( "PROC_SRA", false, 1, &mips::instructions::PROC_SRA_NS::Execute, 0x0, 'n' );
static const mips::instructions::InstructionInfo StaticProc_PROC_NOR ( "PROC_NOR", false, 1, &mips::instructions::PROC_NOR_NS::Execute, 0x0, 'n' );
static const mips::instructions::InstructionInfo StaticProc_PROC_TGE ( "PROC_TGE", false, 1, &mips::instructions::PROC_TGE_NS::Execute, 0x0, 'n' );
static const mips::instructions::InstructionInfo StaticProc_PROC_MULU ( "PROC_MULU", false, 1, &mips::instructions::PROC_MULU_NS::Execute, 0x0, 'n' );
static const mips::instructions::InstructionInfo StaticProc_PROC_MUHU ( "PROC_MUHU", false, 1, &mips::instructions::PROC_MUHU_NS::Execute, 0x0, 'n' );
static const mips::instructions::InstructionInfo StaticProc_PROC_ROTRV ( "PROC_ROTRV", false, 1, &mips::instructions::PROC_ROTRV_NS::Execute, 0x0, 'n' );
static const mips::instructions::InstructionInfo StaticProc_PROC_SRLV ( "PROC_SRLV", false, 1, &mips::instructions::PROC_SRLV_NS::Execute, 0x0, 'n' );
static const mips::instructions::InstructionInfo StaticProc_PROC_SLT ( "PROC_SLT", false, 1, &mips::instructions::PROC_SLT_NS::Execute, 0x0, 'n' );
static const mips::instructions::InstructionInfo StaticProc_PROC_TLTU ( "PROC_TLTU", false, 1, &mips::instructions::PROC_TLTU_NS::Execute, 0x0, 'n' );
static const mips::instructions::InstructionInfo StaticProc_PROC_ADD ( "PROC_ADD", false, 1, &mips::instructions::PROC_ADD_NS::Execute, 0x0, 'n' );
static const mips::instructions::InstructionInfo StaticProc_PROC_JR ( "PROC_JR", true, 1, &mips::instructions::PROC_JR_NS::Execute, 0x160000, 'n' );
static const mips::instructions::InstructionInfo StaticProc_PROC_JALR ( "PROC_JALR", true, 1, &mips::instructions::PROC_JALR_NS::Execute, 0x160000, 'n' );
static const mips::instructions::InstructionInfo StaticProc_PROC_TNE ( "PROC_TNE", false, 1, &mips::instructions::PROC_TNE_NS::Execute, 0x0, 'n' );
static const mips::instructions::InstructionInfo StaticProc_PROC_SUBU ( "PROC_SUBU", false, 1, &mips::instructions::PROC_SUBU_NS::Execute, 0x0, 'n' );
static const mips::instructions::InstructionInfo StaticProc_PROC_SYSCALL ( "PROC_SYSCALL", false, 1, &mips::instructions::PROC_SYSCALL_NS::Execute, 0x0, 'n' );
static const mips::instructions::InstructionInfo StaticProc_PROC_SRL ( "PROC_SRL", false, 1, &mips::instructions::PROC_SRL_NS::Execute, 0x0, 'n' );
static const mips::instructions::InstructionInfo StaticProc_PROC_ROTR ( "PROC_ROTR", false, 1, &mips::instructions::PROC_ROTR_NS::Execute, 0x0, 'n' );
static const mips::instructions::InstructionInfo StaticProc_PROC_XOR ( "PROC_XOR", false, 1, &mips::instructions::PROC_XOR_NS::Execute, 0x0, 'n' );
static const mips::instructions::InstructionInfo StaticProc_PROC_SYNC ( "PROC_SYNC", false, 1, &mips::instructions::PROC_SYNC_NS::Execute, 0x0, 'n' );
static const mips::instructions::InstructionInfo StaticProc_PROC_MUL ( "PROC_MUL", false, 1, &mips::instructions::PROC_MUL_NS::Execute, 0x0, 'n' );
static const mips::instructions::InstructionInfo StaticProc_PROC_MUH ( "PROC_MUH", false, 1, &mips::instructions::PROC_MUH_NS::Execute, 0x0, 'n' );
static const mips::instructions::InstructionInfo StaticProc_PROC_LSA ( "PROC_LSA", false, 1, &mips::instructions::PROC_LSA_NS::Execute, 0x0, 'n' );
static const mips::instructions::InstructionInfo StaticProc_PROC_TLT ( "PROC_TLT", false, 1, &mips::instructions::PROC_TLT_NS::Execute, 0x0, 'n' );
static const mips::instructions::InstructionInfo StaticProc_PROC_DIVU ( "PROC_DIVU", false, 1, &mips::instructions::PROC_DIVU_NS::Execute, 0x0, 'n' );
static const mips::instructions::InstructionInfo StaticProc_PROC_MODU ( "PROC_MODU", false, 1, &mips::instructions::PROC_MODU_NS::Execute, 0x0, 'n' );
static const mips::instructions::InstructionInfo StaticProc_PROC_SELEQZ ( "PROC_SELEQZ", false, 1, &mips::instructions::PROC_SELEQZ_NS::Execute, 0x0, 'n' );
static const mips::instructions::InstructionInfo StaticProc_PROC_SUB ( "PROC_SUB", false, 1, &mips::instructions::PROC_SUB_NS::Execute, 0x0, 'n' );
static const mips::instructions::InstructionInfo StaticProc_PROC_OR ( "PROC_OR", false, 1, &mips::instructions::PROC_OR_NS::Execute, 0x0, 'n' );
static const mips::instructions::InstructionInfo StaticProc_PROC_SDBBP ( "PROC_SDBBP", false, 1, &mips::instructions::PROC_SDBBP_NS::Execute, 0x0, 'n' );
static const mips::instructions::InstructionInfo StaticProc_PROC_SLLV ( "PROC_SLLV", false, 1, &mips::instructions::PROC_SLLV_NS::Execute, 0x0, 'n' );
static const mips::instructions::InstructionInfo StaticProc_PROC_TGEU ( "PROC_TGEU", false, 1, &mips::instructions::PROC_TGEU_NS::Execute, 0x0, 'n' );
static const mips::instructions::InstructionInfo StaticProc_PROC_DIV ( "PROC_DIV", false, 1, &mips::instructions::PROC_DIV_NS::Execute, 0x0, 'n' );
static const mips::instructions::InstructionInfo StaticProc_PROC_MOD ( "PROC_MOD", false, 1, &mips::instructions::PROC_MOD_NS::Execute, 0x0, 'n' );
static const mips::instructions::InstructionInfo StaticProc_PROC_SRAV ( "PROC_SRAV", false, 1, &mips::instructions::PROC_SRAV_NS::Execute, 0x0, 'n' );
static const mips::instructions::InstructionInfo StaticProc_PROC_CLZ ( "PROC_CLZ", false, 1, &mips::instructions::PROC_CLZ_NS::Execute, 0x0, 'n' );
static const mips::instructions::InstructionInfo StaticProc_PROC_SLTU ( "PROC_SLTU", false, 1, &mips::instructions::PROC_SLTU_NS::Execute, 0x0, 'n' );
static const mips::instructions::InstructionInfo StaticProc_PROC_TEQ ( "PROC_TEQ", false, 1, &mips::instructions::PROC_TEQ_NS::Execute, 0x0, 'n' );
static const mips::instructions::InstructionInfo StaticProc_PROC_CLO ( "PROC_CLO", false, 1, &mips::instructions::PROC_CLO_NS::Execute, 0x0, 'n' );
static const mips::instructions::InstructionInfo StaticProc_PROC_ADDU ( "PROC_ADDU", false, 1, &mips::instructions::PROC_ADDU_NS::Execute, 0x0, 'n' );
static const mips::instructions::InstructionInfo StaticProc_PROC_SELNEZ ( "PROC_SELNEZ", false, 1, &mips::instructions::PROC_SELNEZ_NS::Execute, 0x0, 'n' );
static const mips::instructions::InstructionInfo StaticProc_PROC_SLL ( "PROC_SLL", false, 1, &mips::instructions::PROC_SLL_NS::Execute, 0x0, 'n' );
static const mips::instructions::InstructionInfo StaticProc_PROC_AND ( "PROC_AND", false, 1, &mips::instructions::PROC_AND_NS::Execute, 0x0, 'n' );
static const mips::instructions::InstructionInfo StaticProc_PROC_BREAK ( "PROC_BREAK", false, 1, &mips::instructions::PROC_BREAK_NS::Execute, 0x0, 'n' );
static const mips::instructions::InstructionInfo StaticProc_PROC_LB ( "PROC_LB", false, 1, &mips::instructions::PROC_LB_NS::Execute, 0x0, 'n' );
