...
float __strtof_l(const char *restrict s, char **restrict p, struct __locale_struct *l)
{
	return strtof(s, p);
}

double __strtod_l(const char *restrict s, char **restrict p, struct __locale_struct *l)
{
	return strtod(s, p);
}

long double __strtold_l(const char *restrict s, char **restrict p, struct __locale_struct *l)
{
	return strtold(s, p);
}
#else
