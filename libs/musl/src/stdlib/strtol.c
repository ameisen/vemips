...
unsigned long long strtoull_l(const char *restrict s, char **restrict p, int base, struct __locale_struct *l)
{
	return strtoull(s, p, base);
}

long long strtoll_l(const char *restrict s, char **restrict p, int base, struct __locale_struct *l)
{
	return strtoll(s, p, base);
}

unsigned long strtoul_l(const char *restrict s, char **restrict p, int base, struct __locale_struct *l)
{
	return strtoul(s, p, base);
}

long strtol_l(const char *restrict s, char **restrict p, int base, struct __locale_struct *l)
{
