...
#if defined(_LIBUNWIND_TARGET_MIPS32)
  int stepWithCompactEncoding(Registers_mips32 &) {
    return UNW_EINVAL;
  }
#endif
...
#if defined(_LIBUNWIND_TARGET_MIPS32)
  bool compactSaysUseDwarf(Registers_mips32 &, uint32_t *) const {
    return true;
  }
#endif
...
#if defined(_LIBUNWIND_TARGET_MIPS32)
  compact_unwind_encoding_t dwarfEncoding(Registers_mips32 &) const {
    return 0;
  }
#endif
